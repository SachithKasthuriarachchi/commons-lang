 ...
 * </p>
 *
 * <p> {@link org.apache.android.commons.lang3.concurrent.ConstantInitializer} is a very straightforward implementation of the {@code ConcurrentInitializer} interface:
 ...
 * {@code LazyInitializer} declares an abstract {@link org.apache.android.commons.lang3.concurrent.LazyInitializer#initialize() initialize()} method which we have to implement to create the messaging service object:</p>
 *
 * <pre>
 * <code>
 ...
 * </pre>
 *
 * <p>The {@link org.apache.android.commons.lang3.concurrent.AtomicInitializer} class is very similar to {@code LazyInitializer}.
 ...
 *
 * <p>Another implementation of the {@code ConcurrentInitializer} interface is {@link org.apache.android.commons.lang3.concurrent.BackgroundInitializer}.
 ...
 * </pre>
 *
 * <p> Related to {@code BackgroundInitializer} is the {@link org.apache.android.commons.lang3.concurrent.MultiBackgroundInitializer} class.
 ...
 * Then an arbitrary number of {@code BackgroundInitializer} objects is added using the {@link org.apache.android.commons.lang3.concurrent.MultiBackgroundInitializer#addInitializer(String, BackgroundInitializer)} method.
 ...
 * {@code get()} returns an object of type {@link org.apache.android.commons.lang3.concurrent.MultiBackgroundInitializer.MultiBackgroundInitializerResults}.
 ...
 * For users who prefer runtime exceptions in general there is also an {@link org.apache.android.commons.lang3.concurrent.ConcurrentUtils#extractCauseUnchecked(java.util.concurrent.ExecutionException)} method which behaves like {@code extractCause()}, but returns the unchecked exception {@link org.apache.android.commons.lang3.concurrent.ConcurrentRuntimeException} instead.</p>
 *
 ...
 *
 * <p> With {@link org.apache.android.commons.lang3.concurrent.BasicThreadFactory} Commons Lang has an implementation of {@code ThreadFactory} that works out of the box for many common use cases.
 ...
 * Instances of {@code BasicThreadFactory} are created and configured using the nested {@link org.apache.android.commons.lang3.concurrent.BasicThreadFactory.Builder} class.
 ...
 * An instance can wrap another {@code ThreadFactory} implementation; this is achieved by calling the builder's {@link org.apache.android.commons.lang3.concurrent.BasicThreadFactory.Builder#wrappedFactory(java.util.concurrent.ThreadFactory) wrappedFactory(ThreadFactory)} method.
